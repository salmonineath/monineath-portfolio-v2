          ...
          {services.map(service => (
            <Card key={service.endpoint} className="p-6 hover:border-green-500/30 transition-colors group">
              ...
              <div className="flex items-center gap-2 mb-4 font-mono text-xs">
                ...
                <span className="text-gray-400 truncate">{service.endpoint}</span>
              </div>
              <h3 className="text-white font-semibold text-lg mb-3">{service.title}</h3>
              <p className="text-gray-400 text-sm leading-relaxed mb-4">{service.description}</p>
              <p className="font-mono text-[11px] text-gray-600 group-hover:text-green-500/70 transition-colors">
